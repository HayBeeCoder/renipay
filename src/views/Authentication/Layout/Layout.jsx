  ...
  return (
    <section className="w-screen h-screen  relative grid md:flex flex-wrap grid-cols-6  overflow-hidden">
      <div className="absolute top-0 left-0 right-0 bottom-0 flex flex-col justify-between overflow-hidden">
        <p className="md:text-[#F5F5F5] text-faint font-black md:text-[100px] text-[120px] text-left  opacity-5 md:opacity-70">Renipay</p>
        <p className="md:text-[#F5F5F5] text-faint font-black md:text-[100px] text-[120px] text-right -ml-12 md:opacity-50 opacity-5">Renipay</p>
      </div>
